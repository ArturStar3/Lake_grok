...
3. Сохраните все образы в архив:
   ...
   Готовый файл будет называться примерно `infolake_full_offline_20250618_153045.tar`.
...
Этот документ является основным источником инструкций по переносу проекта в оффлайн-среду.