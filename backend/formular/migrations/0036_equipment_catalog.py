# Generated by Django 6.0.6 on 2026-06-25 05:03
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('formular', '0035_alter_actiontype_line_type'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='formular.equipmentcategory', verbose_name='Родительская категория')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='equipment', to='formular.equipmentcategory', verbose_name='Категория')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(blank=True, related_name='parameter_definitions', to='formular.equipmentcategory', verbose_name='Категории техники')),
                ('unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='formular.unitofmeasure', verbose_name='Единица измерения')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parameter_values', to='formular.equipment', verbose_name='Образец техники')),
                ('parameter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='values', to='formular.equipmentparameterdefinition', verbose_name='Параметр')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='deployments', to='formular.equipment', verbose_name='Образец техники')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parameter', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='deployment_zones', to='formular.equipmentparameterdefinition', verbose_name='Параметр ТТХ')),
                ('target_equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='zones', to='formular.targetequipment', verbose_name='Техника на объекте')),
            ],
            options={
